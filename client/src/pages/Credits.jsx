        ...
        <div className='flex flex-wrap justify-center gap-8'>
            {
                plans.map((plan, index) => (
                    <div key={index} className={`border border-gray-200 dark:border-purple-700 rounded-lg shadow hover:shadow-lg transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id === "pro" ? "bg-purple-100 dark:bg-purple-950" : "bg-white dark:bg-transparent"}`}>
