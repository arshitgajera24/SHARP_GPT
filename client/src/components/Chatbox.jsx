...
const Chatbox = () => {
  ...
  const onSubmitHandler = async (e) => {
    try {
      ...
      const {data} = await axios.post(`/api/message/${mode}`, {chatId: selectedChat._id, prompt, isPublished}, config)
      ...
      <div ref={containerRef} className='flex-1 mb-5 overflow-y-scroll'>
        {
          messages.length === 0 && (
            <div className='h-full flex flex-col items-center justify-center gap-2 text-primary'>
              <img src={theme === "dark" ? assets.gpt_main_dark : assets.gpt_main_removebg} className='w-full max-w-56 sm:max-w-68' alt="" />
