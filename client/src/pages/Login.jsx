...
const Login = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
      ...
      {state !== "login" && (
          <div className="flex items-center mt-6 w-full bg-white border border-gray-300/80 focus-within:border-purple-700 h-12 rounded-full overflow-hidden pl-6 gap-2">
      ...
      <div className="flex items-center w-full mt-4 bg-white border border-gray-300/80 focus-within:border-purple-700 h-12 rounded-full overflow-hidden pl-6 gap-2">
      ...
      <div className="flex items-center mt-4 w-full bg-white border border-gray-300/80 focus-within:border-purple-700 h-12 rounded-full overflow-hidden pl-6 gap-2">
      ...
      <div className="mt-4 text-left text-purple-800">
          <button className="text-sm" type="reset">Forget password?</button>
      </div>
      <button type="submit" className="mt-2 w-full h-11 rounded-full text-white bg-linear-to-r from-indigo-600 to-purple-700 hover:from-indigo-700 hover:to-purple-800 cursor-pointer">
